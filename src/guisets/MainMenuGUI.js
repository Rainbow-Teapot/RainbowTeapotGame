...
MainMenuGUI.prototype.create = function(){
    ...
    viewportMiddleY = viewport.height/2 - buttonSpriteOptions.height/2 + 50;
    ...
    let textOptions = new Text(this.scene,"OPCIONES",viewportMiddleX - 5,viewportMiddleY + 35,"30px CartoonRegular");
    ...
    viewportMiddleY = viewport.height/2 - buttonSpriteCredits.height/2 + 100;
    ...
    let textCredits = new Text(this.scene,"CRÉDITOS",viewportMiddleX - 5 ,viewportMiddleY + 35,"30px CartoonRegular");
