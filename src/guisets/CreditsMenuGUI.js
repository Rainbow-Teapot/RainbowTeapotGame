...
CreditsMenuGUI.prototype.create = function(){
    ...
    let c1 = new GUIImage(this.scene, "celia", viewport.width/2- 232, 140, 0, 0, 0, 0); 
    ...
    let c4 = new GUIImage(this.scene, "celia", viewport.width/2-c1.width/2,viewport.height -c1.height -60, 0, 0, 0, 0); 
